...
class DynamicLivestockTableBody extends StatefulWidget {
  ...
  @override
  State<DynamicLivestockTableBody> createState() => DynamicLivestockTableBodyState();
}
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(onPressed: fetchLivestock, child: const Text('Retry')),
          ],
        ),
      );
    }
    ...
    if (_data.isEmpty) {
      return Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            const Text('No livestock records found.'),
            const SizedBox(height: 16),
            ElevatedButton(onPressed: fetchLivestock, child: const Text('Refresh')),
          ],
        ),
      );
    }
